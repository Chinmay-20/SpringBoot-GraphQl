...
//				new Product("Smartphone", "Electronics", 34999.99f, 100),
...
// insert record then we'll delete piece of code
// this will run on application startup and store the record to DB